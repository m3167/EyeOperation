...
{
    [SerializeField] GameObject AvatarSelectionPlatformGameobject;
    ...
    private void Start()
    {
        ...
        if (PhotonNetwork.LocalPlayer.CustomProperties.TryGetValue(MultiplayerVRConstants.AVATAR_SELECTION_NUMBER,
                out storedAvatarSelectionNumber))
        {
        ...
        else
        {
            ...
            {
                avatarSelectionNumber = Random.Range(0, 10);
                ActivateAvatarModelAt(avatarSelectionNumber);
                LoadAvatarModelAt(avatarSelectionNumber);
            }
            else
    ...
    private void LoadAvatarModelAt(int avatarIndex)
    {
        ...
        ExitGames.Client.Photon.Hashtable playerSelectionProp = new ExitGames.Client.Photon.Hashtable()
            { { MultiplayerVRConstants.AVATAR_SELECTION_NUMBER, avatarSelectionNumber } };
