...
public class VRKeyboardManager : MonoBehaviour
{
    ...
    [FormerlySerializedAs("playerNameInputField")]
    public TMP_InputField InputFieldBlock;
    ...
    public void EnableVRKeyboard()
    {
        ...
        //leftBaseController.GetComponent<LineRenderer>().enabled = false;
        rightBaseController.GetComponent<LineRenderer>().enabled = false;
    }
    ...
    public void DisableVRKeyboard()
    {
        ...
        //leftBaseController.GetComponent<LineRenderer>().enabled = true;
        rightBaseController.GetComponent<LineRenderer>().enabled = true;
    }
    ...
    public void HandleUpdate(string text)
    {
        ...
        InputFieldBlock.text = text;
        InputFieldBlock.caretPosition = InputFieldBlock.text.Length;
    }
